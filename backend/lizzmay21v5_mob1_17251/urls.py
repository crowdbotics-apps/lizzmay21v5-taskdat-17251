"""lizzmay21v5_mob1_17251 URL Configuration
...
admin.site.site_header = "lizzmay21v5 taskdating"
admin.site.site_title = "lizzmay21v5 taskdating Admin Portal"
admin.site.index_title = "lizzmay21v5 taskdating Admin"

# swagger
schema_view = get_schema_view(
    openapi.Info(
        title="lizzmay21v5 mob1 API",
        default_version="v1",
        description="API documentation for lizzmay21v5 mob1 App",
    ),
    public=True,
